      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-1 justify-content-between">
          <div class="col-lg-6 order-1 order-lg-1 d-flex flex-column justify-content-center">
            ...
            <div class="hero-button-registration d-none d-md-flex gap-2">
              <a href="/app/register-your-school" class="btn-get-started"> <i class="fa fa-building-o" aria-hidden="true"></i> School Registration</a>
              
              <a href="/app/student-registration" class="btn-get-started-student"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Student Registration</a>
