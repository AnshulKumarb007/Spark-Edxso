    ...
    public function index(){  
      ...
      $exam_listing = DB::select("
        ...
        JOIN 
            ...
            ON 1 = 1
        JOIN 
            subject subj ON jt.subject_id = subj.id
        GROUP BY 
            jt.subject_id, subj.name
    ");            
        return view('admin.dashboard',compact('school_count','student_count','spark_count','lab_count','lab_count1','exam_listing'));
    }
}
