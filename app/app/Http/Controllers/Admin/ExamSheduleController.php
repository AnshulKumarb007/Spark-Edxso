...
class ExamSheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select(
            'exam_shedule.id',
            'exam_shedule.shedule_date as shedule_date','exam_end_date','to_date',
    ...
    public function store(Request $request)
    {
         ...
         try {
               ...
               // $examSchedule->exam_fee = $validated['exam_fee'];
                $examSchedule->to_date = $validated['to_date'];
                $examSchedule->save();
            
                return redirect()->back()->with('success', 'Exam date created successfully.');
            } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $subject->to_date       = $request->to_date;
           ...
           // $subject->discount = $request->discount;
            ...
            return redirect()->route('exam.date')->with('success', 'Exam date updated successfully.');
              } catch (\Exception $e) {
                       // print_r($e->getMessage());
                        return redirect()->back()->with('error', $e->getMessage());
            }
