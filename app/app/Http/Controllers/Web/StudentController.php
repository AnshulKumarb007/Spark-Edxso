...
class StudentController extends Controller
{
    ...
    // public function student_result_page($school_id){
    //       return view('web.student_resultform',compact('school_id'));
    // }
...
//     $theirUid = 'SO06250017710587';

//    $students = ExamResult::where('their_uid',$theirUid)->limit(1)->first();
    
//      $results = DB::table('30jan_examresults as er')
//     ->select(
//         'er.subject_name',
//         // Student Score
//         DB::raw("
//             ROUND(
//                 (SUM(CASE WHEN er.their_uid = '$theirUid'
//                 THEN er.item_level_score END)
//                 /
//                 COUNT(CASE WHEN er.their_uid = '$theirUid' THEN 1 END)
//             ) * 100, 2
//         ) as student_score"),
...
//                     WHEN er.class_id = (
//                         SELECT class_id 
//                         FROM 30jan_examresults 
//                         WHERE their_uid = '$theirUid' 
//                         LIMIT 1
//                     )
//                     THEN er.item_level_score 
//                 END) * 100, 2
//             ) as school_average
//         "),
...
//         ")
//     )
//     ->whereNotNull('er.subject_name')
//     ->groupBy('er.subject_name')
//     ->get();
...
//             return $row;
//         });
//     return view('student_result',compact('results','students'));
