                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Create Exam Date</a></li> 
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <form action="{{route('store.exam.date')}}" method="post">
                                                        ...
                                                        @endphp
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="date" class="form-control" name="shedule_date" id="from_date" required min="{{ $today }}">
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="to_date">Exam To Date <span style="color: red">*</span></label>
                                                                            <input type="date" class="form-control" name="to_date" id="to_date" required min="{{ $today }}">
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="exam_end_date">Last Date of Enrollment<span style="color: red">*</span></label>
                                                                            <input type="date" class="form-control" name="exam_end_date" id="exam_end_date" required min="{{ $today }}">
                                                                        </div>
