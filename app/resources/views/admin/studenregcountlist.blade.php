                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Registered Student Counts</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table datatable" id="schoolTable">
                                    <thead>
                                        <tr class="text-center">
                                            <th colspan="9" style="background:#d6dce4">Student Counts</th>                                                                                                       
                                        </tr> 
                                    ...
                                    <tbody>
                                                        @php
                                                          $total = 0;   
                                                        @endphp
                                        @foreach($formattedResults as $school)
                                            @foreach($school['classes'] as $class)
                                                <tr>
                                                    ...
                                                    @foreach($subjects as $subject)
                                                        ...
                                                        <td>
                                                            @if(isset($class['subjects'][$subject->name]))
                                                                
                                                                @php  
                                                                    $var = (int) $class['subjects'][$subject->name]; 
                                                                    echo $var;
                                                                    $total += $var;
                                                                    $totals += $var;
