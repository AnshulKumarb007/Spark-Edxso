                                ...
                                <table class="table datatable" id="schoolTable">
                                    ...
                                    <tbody> 
                                        @foreach($assessemts as $st)  
                                            <tr> 
                                                <td>{{ $sr++ }}</td> 
                                                <td class="sticky-col text-capitalize">{{ $st->school_name }}</td>   
                                                <td >{{ $st->lab_id }}</td>   
                                                <td >Pc-{{ $st->pc_id }}</td>   
                                                <td >{{ $st->ip }}</td>   
                                                <td >{{ $st->os }}</td>   
                                                ...
                                                <td >{{ $st->js_enabled }}</td>   
                                                <td >{{ $st->ram }}</td>   
                                               <td class="{{ $st->status == 'Pass' ? 'text-success' : 'text-danger' }}">
                                                    {{ $st->status }}
                                                </td>
 
                                                <td >{{ $st->created_at ? date("d-m-Y H:i:s", strtotime($st->created_at)) : '' }}</td>   
