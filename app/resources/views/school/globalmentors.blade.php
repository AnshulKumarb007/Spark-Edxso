                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-10">
                                        <div class="page-header-title">
                                            <h5>Global Mentors</h5>
                                        </div>
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{url('school-dashboard')}}"><i
                                                        class="feather icon-home"></i></a></li>
                                            <li class="breadcrumb-item"><a href="#">Global Mentors/ {{$val}}</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-2">
                                        <ul class="breadcrumb">
                                            <a href="{{asset('International_Steering_Committee.pdf')}}" class="btn btn-outline-danger" role="button" target="_blank">
                                ...
                                <div class="col-lg-12 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="card card-social">
                                        <div class="card-block">
                                            <div class="row scan1">
                                                @if($val == 'G. Balasubramanian')
                                                <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                    data-aos-delay="200"><img
                                                        src="https://sparkolympiads.com/assets/img/Steering_Committee/image5.jpg"
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    src="https://sparkolympiads.com/assets/img/Steering_Committee/image15.png"
                                                    alt="" class="img-fluid services-img"></div>
                                            <div class="col-lg-8">
                                        ...
                                        @elseif($val == 'Dr. Rajesh Hassija')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    src="https://sparkolympiads.com/assets/img/Steering_Committee/hassija.jpg"
                                                    alt="" class="img-fluid services-img"></div>
                                           <div class="col-lg-8"><h3 class="font">Dr. Rajesh Hassija, Quality Head, ISCAR</h3>
                                        ...
                                        @elseif($val == 'Kevin Baird')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    src="https://sparkolympiads.com/assets/img/Steering_Committee/Kevin Baird.jfif"
                                                    alt="" class="img-fluid services-img"></div>
                                          <div class="col-lg-8"><h3 class="font">Kevin Baird, Predictive Analytics, ISCAR</h3>
                                         ...
                                         @elseif($val == 'Dr. Swati Popat Vats')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    src="https://sparkolympiads.com/assets/img/Steering_Committee/SwatiPopat.png"
                                                        alt="" class="img-fluid services-img"></div>
                                                    <div class="col-lg-8"><h3 class="font">Dr. Swati Popat Vats, K-5 Assessment, ISCAR</h3>
                                        ...
                                        @elseif($val == 'Dr. Jesús Jara')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Dr. Jesús Jara, AI in K12 Assessment, ISCAR</h3>
                                        ...
                                        @elseif($val == 'Mrs. Abha Meghe')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Mrs. Abha Meghe</h3>
                                        ...
                                        @elseif($val == 'Dr. Andrew Ordover')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Dr. Andrew Ordover, Ed.D.</h3>
                                        ...
                                        @elseif($val == 'Humphrey Chan')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Humphrey Chan</h3>
                                         ...
                                         @elseif($val == 'Pamit Anand')
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Pamit Anand</h3>
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Vishnu Patro, Test Delivery, ISCAR</h3>
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Pramod Sharma</h3>
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Ms. Sneh Verma</h3>
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Dr. Punam Kashyap</h3>
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Ms. Sangeeta Krishane</h3>
                                            ...
                                            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up"
                                                data-aos-delay="200"><img
                                                    ...
                                                    <div class="col-lg-8"><h3 class="font">Giri Balasubramaniam</h3>
