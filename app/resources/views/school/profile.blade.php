                                ...
                                <div class="col-md-12 col-xl-12">
                                    <div class="card card-social">										 
                                        <div class="card-block">		
                                                <p><b style="font-weight:900">Instruction: </b> Maecenas lobortis non justo at tincidunt. Cras magna quam, consequat nec sapien sed, blandit faucibus lacus. Vivamus hendrerit, ipsum quis elementum lacinia, lectus urna convallis lacus, at rhoncus libero metus eu augue. Nulla sed auctor mauris. Quisque pretium lorem leo, in tincidunt lorem congue sit amet. Ut quis dolor sed metus finibus iaculis a gravida massa. Vivamus mollis mauris et sem porta commodo. Vestibulum libero nisl, tempus ut mauris vitae, luctus elementum orci. </p>       
                                ...
                                <div class="col-md-12 col-xl-12">
                                    <div class="card card-social">										 
                                        ...
                                        <div class="col-md-8"> 
                                            ...
                                            @csrf
                                            <label   class="form-label">Upload Your School Logo</label>
                                    ...
                                    <div class="card-header" id="headingOne">
                                      <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                        <a href="#!"
                                          ...
                                          <i class="fas fa-chevron-up toggle-arrow" data-target="#collapseOne"></i> <!-- Now uses class -->
                                        </a>
                                      </h5>
                                    </div>
                                            ...
                                            <div class="card-header" id="headingTwo">
                                              <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                <a href="#!" 
                                                  ...
                                                  <i class="fas fa-chevron-down toggle-arrow" data-target="#collapseTwo"></i>
                                                </a>
                                              </h5>
                                            </div>
                                            ...
                                            <div class="card-header" id="headingThree">
                                              <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                <a href="#!"
                                                  ...
                                                  <span>Spark Coordinator Details</span>
                                            ...
                                            <div class="card-header" id="headingThree1">
                                              <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                <a href="#!"
                                                  ...
                                                  <span>School Enrollment/Lab Details</span>
                                                  <i class="fas fa-chevron-down toggle-arrow" data-target="#collapseThree1"></i>
                                                </a>
                                              </h5>
                                            </div>
