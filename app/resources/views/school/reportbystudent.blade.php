...
<ul>
  <li>Use this panel to download students Report And Certificate for SPARK Olympiads.</li>
		...
		<div class="card-header"> 
				  <form method="GET" action="{{ url()->current() }}" class="mb-4">
						  <div class="row">
							  ...
							  <div class="col-md-6">
								<label for="subject" class="form-label">Student Name</label>
								  <input type="text" name="student_name"  placeholder="Enter Student Name" class="form-control" style="height:33px;background:white"/>
							  </div> 
							 </div>
							 <div class="row">
