            ...
            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="form-container">
                    ...
                    <form action="{{ route('school.store') }}" method="POST">
                        <input type="hidden" name="registration_id" value="{{ Session::get('schoolid')?? request()->get('video_id') }}">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label"><span>Select Board</span><span class="text-danger">*</span> <i class="fa fa-info text-black ms-1 information"
                        ...
                        <div class="mb-3 position-relative">
                            <label for="school_name" class="form-label">School Name<span class="text-danger">*</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="state-dropdown" class="form-label">State<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="district-dropdown" class="form-label">District<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="city-dropdown" class="form-label">Village/Town/City<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="city_id" placeholder="Village/Town/City" @if(!empty($school)) value="{{ $school->city_id }}" @endif required maxlength="150" />
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="city-dropdown" class="form-label">Pin Code<span class="text-danger">*</span></label>
...
@if(request()->get('video_url'))
    <script>
        window.onload = function() {
            window.open("{{ request()->get('video_url') }}", "_blank", "width=600,height=400");
        }
    </script>
@endif
