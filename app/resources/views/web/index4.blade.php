                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-9">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name" @if(!empty($head_of_school)) value="{{ $head_of_school->first_name }}" @endif required placeholder="Enter First Name" maxlength="50">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="second_name" id="second_name" @if(!empty($head_of_school)) value="{{ $head_of_school->second_name }}" @endif placeholder="Enter Middle Name" maxlength="50">
                                    @error('second_name')
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="last_name" id="third" @if(!empty($head_of_school)) value="{{ $head_of_school->last_name }}" @endif placeholder="Enter Last Name" required maxlength="50">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="designation" class="form-label">Designation<span class="text-danger">*</span>
                                        <i class="fa fa-info text-black ms-1 information"
                                            data-bs-toggle="tooltip"
                                            data-bs-placement="right"
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status === 'ok') {
                    ...
                    mobileStatus.text('Entered mobile no. is already registered.').removeClass('text-success').addClass('text-danger');
...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status === 'ok') {
                    ...
                    emailStatus.text('Entered email id. is already registered.').removeClass('text-success').addClass('text-danger');  
                    submitBtn.disabled = true;
                }else {
    ...
    $('#verifyEmailOtp').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status === 'ok') {
                    emailStatus.text('Email address verified successfully').removeClass('text-danger').addClass('text-success');
...
document.getElementById('mobile').addEventListener('input', function () {
    ...
    if (input === '') {
        ...
        errorDiv.innerText = 'Enter a valid 10-digit mobile (not starting with 0).';
    }
});
