    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
         <div class="services-list">
          ...
          <a href="{{ url('dr-swati-popat')}}" class="active">Dr. Swati Popat Vats</a>
      ...
      <div class="col-lg-8">
        ...
        <div class="row scan1">
          <div class="col-lg-4">
            <img src="{{ asset('../assets/img/Steering_Committee/SwatiPopat.png')}}" alt="Dr. Swati Popat Vats" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
