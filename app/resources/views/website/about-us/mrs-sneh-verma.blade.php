    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="mrs-sneh-verma.php" class="active">Ms. Sneh Verma</a>
      ...
      <div class="col-lg-8">
        ...
        <div class="row scan1">
          <div class="col-lg-4">
            <img src="../assets/img/Steering_Committee/sneh verma.png" alt="Ms. Sneh Verma" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
