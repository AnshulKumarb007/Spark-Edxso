      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-1 justify-content-between">
          <div class="col-lg-6 order-1 order-lg-1 d-flex flex-column justify-content-center">
            <h4 class="hero-heading2"><span class="accent hero-heading-text">India's First Fully<br>Online Olympiad</span> <!--<span class="accent hero-heading-text">Innovative.</span> <span class="accent">Impactful.</span>--></h4>
            <p>Crafted for schools that believe assessments should be innovative, inspiring, insightful, and impactful to foster excellence and celebrate individual potential.</p>
            <!--<p>Crafted for futuristic schools that believe assessments should inspire learning, empower teachers, and celebrate every child�s potential.</p>-->
            <div class="hero-button-registration d-none d-md-block">
              <a href="{{url('app/register-your-school')}}" class="btn-get-started">Register Your School</a>
            </div>
          </div>

          <!--<div class="col-lg-5 order-2 order-lg-2 px-0 d-block">
            <img src="assets/img/hero-img.png" class="img-fluid" alt="">
          </div>-->
          <!-- Desktop Image -->
<div class="col-lg-5 order-2 px-0 d-none d-md-block">
  <img src="{{asset('assets/img/hero-img.png')}}" alt="" class="img-fluid w-100" />
</div>
          <!-- Mobile Image -->
<div class="col-lg-5 order-1 px-0 d-block d-md-none">
  <img src="{{asset('assets/img/hero-img-mobile1.png')}}" alt="" class="img-fluid w-100" />
        ...
        <div class="container position-relative">
          <div class="row gy-4 mt-5 icon-box">
            ...
            <div class="col-xl-6 col-md-6 partner-info">
              <div>
                <div class="icon"><img src="{{asset('assets/img/edxso-logo.png')}}" alt=""></div>
            ...
            <div class="col-xl-6 col-md-6 partner-info">
              <div>
                <div class="icon02"><img src="{{asset('assets/img/prometric-logo.png')}}" alt=""></div>
      ...
      <div class="swiper-wrapper gy-4 mt-5 icon-box">
        ...
        <div class="swiper-slide col-xl-6 col-md-6 partner-info">
          <div class="prometric-card">
            <div class="prometric-logo">
              <div class="icon">
                <img src="{{asset('assets/img/edxso-logo.png')}}" alt="">
              </div>
            </div>
        ...
        <div class="swiper-slide col-xl-6 col-md-6 partner-info">
          <div class="prometric-card">
            <div class="prometric-logo">
              <div class="icon02">
                <img src="{{asset('assets/img/prometric-logo.png')}}" alt="">
              </div>
            </div>
...
When your school participates in SPARK, you're not just investing in meaningful assessments�you�re contributing to a cleaner, greener, and more sustainable future.</p>
    ...
    <section id="about" class="about section top-margin">
     ...
     <img src="{{asset('assets/img/section3-labimage.png')}}" class="img-fluid" alt="">
        <div class="content row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-10">
            <div class="text-center">
              <div class="certificate">
             <img src="{{asset('assets/img/certificate-logo.svg')}}"></a>
             </div>
             <p class="caption">Exclusive For Participating Schools</p>
              ...
              <a class="cta-btn" href="{{url('computer-lab-readiness')}}">See Certification Process</a>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <div class="arrow-center">
                <a href="{{url('international-steering-committee/g-balasubramanian')}}" class="readmore stretched-link">
                  <img src="{{asset('assets/img/readmore-arrow.svg')}}">
                </a>
              </div>
              <div class="icon numbers-six-reasions">
                <img src="{{asset('assets/img/numbers/img-1.svg')}}">
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item service-item-blue position-relative">
              ...
              <a href="{{url('about/prometric')}}" class="readmore stretched-link">
              <div class="arrow-center">
              <img src="{{asset('assets/img/readmore-arrow-white.svg')}}"></a></div>

               <div class="icon numbers-six-reasions">
                <img src="{{asset('assets/img/numbers/img-2.svg')}}">
              </div>
            </div>
           ...
           <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <a href="{{url('competency-architecture')}}" class="readmore stretched-link">
              <div class="arrow-center">
                <img src="{{('assets/img/readmore-arrow.svg')}}"></a></div>

               <div class="icon numbers-six-reasions">
                <img src="{{asset('assets/img/numbers/img-3.svg')}}">
              </div>
            </div>
          </div><!-- End Service Item -->
         <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item service-item-blue position-relative">
              ...
              <a href="{{url('computer-lab-readiness')}}" class="readmore stretched-link">

              <div class="arrow-center">
                <img src="{{asset('assets/img/readmore-arrow-white.svg')}}"></a></div>

               <div class="icon numbers-six-reasions">
                <img src="{{asset('assets/img/numbers/img-4.svg')}}">
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <a class="readmore stretched-link">
                <div class="arrow-center">
                  <img src="{{asset('assets/img/readmore-arrow.svg')}}"></a></div>

               <div class="icon numbers-six-reasions">
                <img src="{{asset('assets/img/numbers/img-5.svg')}}">
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item service-item-blue position-relative">
              ...
              <a href="{{url('awards-and-acolades')}}" class="readmore stretched-link">
                <div class="arrow-center">
                  <img src="{{asset('assets/img/readmore-arrow-white.svg')}}"></a></div>

               <div class="icon numbers-six-reasions">
                <img src="{{asset('assets/img/numbers/img-6.svg')}}">
              </div>
            </div>
          </div><!-- End Service Item -->
...
<!-- Repeat same 5 boxes inside swiper-slide -->
              ...
              <div class="swiper-slide">
                <div class="service-item service-item-blue position-relative">
                  ...
                  <div class="arrow-center">
                    <a href="{{url('about/prometric')}}" class="readmore stretched-link">
                      <img src="{{asset('assets/img/readmore-arrow-white.svg')}}">
                    </a>
                  </div>
                  <div class="icon numbers-six-reasions">
                    <img src="{{asset('assets/img/numbers/img-2.svg')}}">
      ...
      <div class="six-reasons-button text-center mt-4">
        <a href="{{url('app/register-your-school')}}" class="button-header-registration btn-get-started">Register Your School</a>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-4 subject-logo">
            <img src="{{asset('assets/img/logo.svg')}}" alt="" class="img-fluid img-logo-size">
          </div>
...
<section id="team" class="team section">
  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide">
      <div class="member">
        <img src="{{asset('assets/img/subject/english-img.jpg')}}" class="img-fluid" alt="">
        <h4>English</h4>
        <span>Vocabulary, reading comprehension, grammar, expression, fluency, and communication skills.</span>
        <div class="social">
          <a><img src="{{asset('assets/img/readmore-arrow.svg')}}"></a>
        </div>
      </div>
    </div>
    ...
    <div class="swiper-slide">
      <div class="member">
        <img src="{{asset('assets/img/subject/mathamatics-img.jpg')}}" class="img-fluid" alt="">
        <h4>Mathematics</h4>
    ...
    <div class="swiper-slide">
      <div class="member">
        <img src="{{asset('assets/img/subject/evs-img.jpg')}}" class="img-fluid" alt="">
        <h4>EVS</h4>
    ...
    <div class="swiper-slide">
      <div class="member">
        <img src="{{asset('assets/img/subject/science-img.jpg')}}" class="img-fluid" alt="">
        <h4>Science</h4>
    ...
    <div class="swiper-slide">
      <div class="member">
        <img src="{{asset('assets/img/subject/india-Awareness-img.jpg')}}" class="img-fluid" alt="">
 ...
 <!-- fees-shedule Section -->
          ...
          <div class="row gy-4 mt-5 icon-box icon-box02">
            ...
            <div class="col-xl-6 col-md-6">
              <div class="fees-shedule-box title04">
                <h4>Schedule 2025</h4>
                <p>18th November - 27th November<br> 2nd December - 11th December</p>
        ...
        <div class="row gy-4 blueprint-img">
          ...
          <div class="col-xl-12 col-md-12" data-aos="fade-up" data-aos-delay="100">
            <article>
              ...
              <div class="post-img">
                <img src="{{asset('assets/img/blueprint.svg')}}" alt="" class="img-fluid">
              </div>

              <a href="{{url('sample-question')}}" class="button-header-registration btn-get-started">See Sample Questions</a>
  ...
  <div class="container">
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="{{asset('assets/img/p-1.png')}}" alt="Level 1" class="img-fluid">
        </div>
        <div class="swiper-slide">
          <img src="{{asset('assets/img/p-2.png')}}" alt="Level 2" class="img-fluid">
        </div>
        <div class="swiper-slide">
          <img src="{{asset('assets/img/p-3.png')}}" alt="Level 3" class="img-fluid">
        </div>
      </div>
...
<!-- /Recent Posts Section -->
                ...
                <div class="portfolio-info portfolio-info1 d-flex justify-content-center align-items-center">
                  <div class="col-xl-10">
                    <div class="text-center">
                      ...
                      <a class="readmore stretched-link"><img src="{{asset('assets/img/readmore-arrow-white.svg')}}"></a>
                    </div>
                  </div>
                </div>
                <a  class="glightbox">
                  <img src="{{asset('assets/img/grid/grid-1.png')}}" class="img-fluid" alt="">
                </a>
              </div>
            </div>
          </div>
                ...
                <div class="portfolio-info portfolio-info2 d-flex justify-content-center align-items-center">
                  <div class="col-xl-10">
                    <div class="text-center">
                      ...
                      <a  class="readmore stretched-link"><img src="{{asset('assets/img/readmore-arrow.svg')}}"></a>
                    </div>
                  </div>
                </div>
               
                  <img src="{{asset('assets/img/grid/grid-2.png')}}" class="img-fluid" alt="">
          ...
          <div class="swiper-slide">
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                ...
                <a class="glightbox">
                  <img src="{{asset('assets/img/grid/grid-3.png')}}" class="img-fluid" alt="">
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                <div class="portfolio-info portfolio-info1 d-flex justify-content-center align-items-center">
                  ...
                  <img src="{{asset('assets/img/grid/grid-4.png')}}" class="img-fluid" alt="">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                <div class="portfolio-info portfolio-info1 d-flex justify-content-center align-items-center">
                  ...
                  <img src="{{asset('assets/img/grid/grid-5.png')}}" class="img-fluid" alt="">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                <div class="portfolio-info portfolio-info2 d-flex justify-content-center align-items-center">
                  ...
                  <img src="{{asset('assets/img/grid/grid-6.png')}}" class="img-fluid" alt="">
   ...
   <!-- Call To Action Section -->
    <section id="call-to-action" class="d-none d-md-block call-to-action call-to-action02 award-section section dark-background">
      ...
      <div class="container">
        <img class="object-fit-contain border rounded" src="{{asset('assets/img/awaord-img.png')}}" alt="">
        <div class="content row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-10">
            <div class="text-center01">
              ...
              <a class="cta-btn" href="{{url('awards-and-acolades')}}">View Award Details</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="d-block d-md-none">
                 <div class="container">
                 <div class="row">
                     <img src="{{asset('assets/img/awaord_1.png')}}" class="" alt="award" />
                 </div>
             </div>
             <div class="mt-4 text-center">
                 ...
                 <a href="{{url('awards-and-acolades')}}" class="button-header-registration btn-get-started text-center">View Award Details</a>
            </div>
            </section>
  ...
  <!-- Section Lao Apne School Mein Spark -->
      <div class="container section-title getready-title" style="border-radius: 50px 50px 0px 0px;" data-aos="fade-up">
        <h5 class="laoo-apne-school">Lao Apne <span class="school">School</span> Mein <img class="logo-spark-size" src="{{asset('assets/img/onysparklogo.svg')}}"></h5>
    <div class="lao-apne-school-button">
           <a href="{{url('app/register-your-school')}}" class="button-header-registration btn-get-started">Register Your School</a></div>
      </div>
