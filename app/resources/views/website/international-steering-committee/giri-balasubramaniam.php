    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="giri-balasubramaniam.php" class="active">Giri Balasubramaniam</a>
        </div>
      </div>
      ...
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row scan1">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <img src="../assets/img/Steering_Committee/gir.jpg" alt="Giri Balasubramaniam" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
