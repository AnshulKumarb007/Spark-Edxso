    ...
    <div class="container footer-top">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-12 footer-links">
          <h4>Contact Info</h4>
          <ul>
           <li><a href="mailto:reachout@sparkolympiads.com">reachout@sparkolympiads.com</a></li>
            ...
            <div class="row gy-5 justify-content-between">
                ...
                <div class="col-lg-12 form-css">
                    <div class="registration-box text-left">
                        ...
                        <p>Enter your full name and mobile number or email id as a school representative for one step registration. We will connect you with our support executive.</p>
                        ...
                        <form id="contactForm" method="POST" action="submit.php">
                                ...
                                <div class="privacy-box">
                                    ...
                                    <span class="text-black"><b>Note</b>: This registration page is intended exclusively for school administrators only. Students are not permitted to register through this page. If you are a student, please contact your school and request registration link.</span>
                                </div>
...
<div class="footer-text text-black text-center mt-3">
                            Already have an account? <a href="/app/school-login?video_confrensh=1" style="color:#0056b3">LOGIN</a>
                              ...
                              <div class="d-flex justify-content-evenly mt-3">
                                  <a target="_blank" class="text-muted text-small text-decoration-underline" href="/privacy-policy.php"><small>Privacy Policy</small></a>
                                  <a target="_blank" class="text-muted text-small text-decoration-underline" href="/terms-and-conditions.php"><small>Terms & Conditions</small></a>
                              </div>

                              <div class="copyright text-black mt-3">
                                  SPARK OLYMPIADS © <?=date('Y');?>. All rights reserved.
                              </div>
