    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="dr-punam-kashyap.php" class="active">Dr. Punam Kashyap</a>
      ...
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row scan1">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <img src="../assets/img/Steering_Committee/punam kashyap.png" alt="Dr. Punam Kashyap" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
