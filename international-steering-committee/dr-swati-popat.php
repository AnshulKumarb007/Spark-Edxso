    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="dr-swati-popat.php" class="active">Dr. Swati Popat Vats</a>
      ...
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row scan1">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <img src="../assets/img/Steering_Committee/SwatiPopat.png" alt="Dr. Swati Popat Vats" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
            <h3 class="font">Dr. Swati Popat Vats, K-5 Assessment, ISCAR</h3>
            <h5 class="font">President - Podar Education Network <br> Founder-President, Early Childhood Association, Association for Primary Education and Research</h5>
            <p class="font">
