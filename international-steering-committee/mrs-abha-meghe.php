    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="mrs-abha-meghe.php" class="active">Mrs. Abha Meghe</a>
      ...
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row scan1">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <img src="../assets/img/Steering_Committee/abha meghe.png" alt="Mrs. Abha Meghe" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
