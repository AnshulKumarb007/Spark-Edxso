        ...
        <div class="container">
          ...
          <div class="row d-flex justify-content-center text-center">
            ...
            <div class="col-lg-10">
              ...
              <h1>National Recognition, Rewards and Prestige </h1>
      ...
      <nav class="breadcrumbs">
        ...
        <div class="container">
          ...
          <ol>
            ...
            <li class="current">National Recognition, Rewards & Prestige </li>
    ...
    <section id="service-details" class="service-details section scan">
      ...
      <div class="container">
        ...
        <div class="row ">
          ...
          <div class="col-lg-12 scan1" data-aos="fade-up" data-aos-delay="200">
            ...
            <ul class="font a">
                <li>
               <p>   <b>Note:</b> Awards are subject to a minimum participation of 25 students per class per subject.</p>
                </li>
              </ul>
        </div>
