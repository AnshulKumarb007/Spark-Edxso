    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="dr-andrew-odover.php" class="active">Dr. Andrew Ordover</a>
      ...
      <div class="col-lg-8" >
        ...
        <div class="row scan1">
          <div class="col-lg-4" >
            <img src="../assets/img/Steering_Committee/and.jpg" alt="Dr. Andrew Ordover" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
