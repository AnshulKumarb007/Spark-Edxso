    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="mrs-sangita-krishan.php" class="active">Ms. Sangeeta Krishan</a>
      ...
      <div class="col-lg-8" >
        ...
        <div class="row scan1">
          <div class="col-lg-4">
            <img src="../assets/img/Steering_Committee/sangeeta krishan.jfif" alt="Ms. Sangeeta Krishan" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
