    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="services-list">
          ...
          <a href="dr-jesus-jara.php" class="active">Dr. Jesús Jara</a>
      ...
      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row scan1">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <img src="../assets/img/Steering_Committee/jesus Jara.png" alt="Dr. Jesús Jara" class="img-fluid services-img">
          </div>
          <div class="col-lg-8">
