        ...
        <div class="container">
          ...
          <div class="row d-flex justify-content-center text-center">
            ...
            <div class="col-lg-10">
              ...
              <h1>Computer Lab Certification</h1>
      ...
      <nav class="breadcrumbs">
        ...
        <div class="container">
          ...
          <ol>
            ...
            <li class="current">Computer Lab Certification</li>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="services-list">
              ...
              <a href="computer-lab-certification.php">Operating System and Browser Requirements</a>

              <a href="memory-and-network.php" class="active">Memory and Network Requirements</a>
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-12">
             ...
             <h3 class="font">Internet/Network</h3>
              ...
              <ul class="font">
               ...
               <h3 class="font">Wireless Guidelines</h3>
